...
CREATE TABLE computer_inventory (
  ...
  latest_darwin_os_number INT,
  url VARCHAR(255)
);

-- Create os_support table
...
INSERT INTO macOS_versions (version_name, release_name, darwin_os_number, date_announced, date_released, date_latest_release) VALUES
...
-- Insert data into computer_inventory table
INSERT INTO computer_inventory (model_name, model_identifier, model_number, part_number, serial_number, darwin_os_number, latest_darwin_os_number, url) VALUES
